...
public class Psicologo : Person{
    ...
    public Psicologo(int id, string name, string cpf, int age, string password, string espciacilization, string crp, string email, int psychologistId) : base(name, cpf, age, password, email, id, role: "P"){
        CRP = crp;
